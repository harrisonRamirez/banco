...
<body>
	...
	<!--INDICA LA UBIACIÓN DEL LA PÁGINA-->
	    ...
	    <li><a href="index_cliente.php">Cliente</a></li>
			...
			<?php
			if (isset($_GET['mod']) &&  $_GET['mod']==1){	echo '<li class="active">Nuevo Cliente</li>';}
		...
		<div class="	 container-fluid">
					...
					<div class="contenido_datos">
						<?php
						if (isset($_GET['mod']) && $_GET['mod']==1){ include('includes/clientes/cli_dat.php');}
						if (isset($_GET['mod']) && $_GET['mod']==2){include('includes/cuenta/cta_dat.php');}
						?>
