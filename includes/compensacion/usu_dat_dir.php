...
<div class="extra">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<td><a class="btn btn-success" onclick="usu_dir_guardar()"><span class="mdi-content-save"></span></a></td>
		</tr>
	</table>

</div>
<div class="usu_dat_dir" style=" max-height: 200px;overflow: auto;"></div>
	...
	function usu_dir_detalle(){
		$.ajax({
			type:"POST",
			url: "includes/usuarios/usu_dat_dir_detalle.php",
			data:"id_usuario=<?php echo $id_usuario;?>",
				success: function(resp){
				      $('.usu_dat_dir').html(resp);

				}
			});
	}

	function usu_dir_guardar(){
	...
	// $('.bloqueo').show(0);
		$.ajax({
			...
			data:"tipo=DIRECCION&usuario="+usuario+"&dir_tipo="+dir_tip+"&dir_pais="+dir_pais+"&dir_dep="+dir_dep+"&dir_mun="+dir_mun+"&dir_zon="+dir_zon+"&dir_dir="+dir_dir,
