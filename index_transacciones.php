...
<body>
	...
	<!--INDICA LA UBIACIÓN DEL LA PÁGINA-->
	    ...
	    <li><a href="index_cliente.php">Transacciones</a></li>

			<!-- CAMBIA LA INFORMACIÓN DE LA PÁGINA ACTUAL  -->
			<?php
			if (isset($_GET['mod']) && $_GET['mod']==1){	echo '<li class="active">Entre Cuentas</li>';}
			if (isset($_GET['mod']) && $_GET['mod']==2){	echo '<li class="active">Cheques</li>';}
			if (isset($_GET['mod']) && $_GET['mod']==3){	echo '<li class="active">Depositos</li>';}
			?>
		...
		<div class="	 container-fluid">
					...
					<div class="contenido_datos">
						<?php
						if (isset($_GET['mod']) && $_GET['mod']==1){include('includes/transaccion_cuenta/tra_cta_dat.php');}
						if (isset($_GET['mod']) && $_GET['mod']==2){include('includes/transaccion_cheque/tra_chq_dat.php');}
						if (isset($_GET['mod']) && $_GET['mod']==3){include('includes/transaccion_deposito/cta_dat.php');}
						?>
