...
<div class="" style="float:left">
  <span class="icono mdi-image-collections" ></span>
</div>
<div class="titulo">
Iconos <br>
  <small class="subtitulo">Listado de iconos para utilizar</small>
  <small class="subtitulo" style="position:absolute;top:10px;right:25px;color:#ccc">gen_ico. php</small>
</div>
                    <h2>action</h2>
                    <br>
